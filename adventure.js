...
if (lighton) {
  ...
  console.log("Which door will you enter?")
  var doorchoice = prompt('(L/R/F)');
  ...
  console.log('Do you grab the finger and break it off, run away, or scream?');
  var darkaction = prompt('(breakoff/run/scream)');
